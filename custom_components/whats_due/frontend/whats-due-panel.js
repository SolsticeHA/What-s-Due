...
`;class bt extends nt{constructor(){super(...arguments),this.label="",this.value="",this._onChange=t=>{this._emit(t.detail.value)}}render(){return t="ha-icon-picker",void 0!==customElements.get(t)?q`
        <ha-icon-picker
          .label=${this.label}
          .value=${this.value}
      ...
      ></ha-textfield>
      ${this.value?q`<ha-icon .icon=${this.value}></ha-icon>`:F}
  ...
  `,t([ht()],bt.prototype,"label",void 0),t([ht()],bt.prototype,"value",void 0),yt("wd-icon-picker",bt);class At extends nt{constructor(){super(...arguments),this.categories=[],this._cancel=()=>{this.dispatchEvent(new CustomEvent("cancel"))},this._save=()=>{this._local.name.trim()&&this._local.due_date&&this.dispatchEvent(new CustomEvent("save",{detail:this._local}))}}willUpdate(t){t.has("draft")&&this.draft&&(this._local={...this.draft})}_patch(t,e){this._local={...this._local,[t]:e},this.requestUpdate()}render(){if(!this._local)return F;const t=this.strings,e=this._local;return q`
      <ha-dialog
        open
    ...
    `}}function Ct(t){return{id:t.id,name:t.name,icon:t.icon,color:t.color}}At.styles=_t,t([ht({attribute:!1})],At.prototype,"strings",void 0),t([ht({attribute:!1})],At.prototype,"categories",void 0),t([ht({attribute:!1})],At.prototype,"draft",void 0),t([pt()],At.prototype,"_local",void 0),yt("wd-item-dialog",At);class Et extends nt{constructor(){super(...arguments),this._cancel=()=>this.dispatchEvent(new CustomEvent("cancel")),this._save=()=>{this._local.name.trim()&&this.dispatchEvent(new CustomEvent("save",{detail:this._local}))}}willUpdate(t){t.has("draft")&&this.draft&&(this._local={...this.draft})}_patch(t,e){this._local={...this._local,[t]:e},this.requestUpdate()}render(){if(!this._local)return F;const t=this.strings,e=this._local;return q`
      <ha-dialog
        open
    ...
    `],t([ht({attribute:!1})],Et.prototype,"strings",void 0),t([ht({attribute:!1})],Et.prototype,"draft",void 0),t([pt()],Et.prototype,"_local",void 0),yt("wd-category-dialog",Et);class kt extends nt{constructor(){super(...arguments),this.categories=[],this._close=()=>this.dispatchEvent(new CustomEvent("close")),this._add=()=>this.dispatchEvent(new CustomEvent("add"))}_edit(t){this.dispatchEvent(new CustomEvent("edit",{detail:t}))}_delete(t){this.dispatchEvent(new CustomEvent("delete",{detail:t}))}render(){const t=this.strings;return q`
      <ha-dialog
        open
    ...
    `],t([ht({attribute:!1})],kt.prototype,"strings",void 0),t([ht({attribute:!1})],kt.prototype,"categories",void 0),yt("wd-categories-dialog",kt);const St=["warning","urgent","critical","expired"];class Dt extends nt{constructor(){super(...arguments),this.notifyServices=[],this._cancel=()=>this.dispatchEvent(new CustomEvent("cancel")),this._save=()=>{this.dispatchEvent(new CustomEvent("save",{detail:this._local}))}}willUpdate(t){t.has("settings")&&this.settings&&(this._local={...this.settings,notifications:{...this.settings.notifications,targets:[...this.settings.notifications?.targets??[]],statuses:[...this.settings.notifications?.statuses??[]]}})}_patch(t,e){this._local={...this._local,[t]:e},this.requestUpdate()}_patchNotif(t,e){this._local={...this._local,notifications:{...this._local.notifications,[t]:e}},this.requestUpdate()}_toggleStatus(t,e){const i=new Set(this._local.notifications.statuses);e?i.add(t):i.delete(t),this._patchNotif("statuses",Array.from(i))}_toggleTarget(t){const e=new Set(this._local.notifications.targets);e.has(t)?e.delete(t):e.add(t),this._patchNotif("targets",Array.from(e))}_num(t){const e=parseInt(t.target.value,10);return Number.isFinite(e)&&e>=0?e:0}_renderNotifBody(t){const e=this.strings,i=[...this.notifyServices].sort();for(const e of t.targets)i.includes(e)||i.push(e);return q`
    ...
    `}_statusLabel(t){const e=this.strings;switch(t){case"warning":return e.statusWarning;case"urgent":return e.statusUrgent;case"critical":return e.statusCritical;case"expired":return e.statusExpired}}render(){if(!this._local)return F;const t=this.strings,e=this._local,i=e.notifications;return q`
      <ha-dialog
        open
        heading=${t.settings}
        @closed=${t=>{t.detail?.action&&this._cancel()}}
    ...
    `],t([ht({attribute:!1})],Dt.prototype,"strings",void 0),t([ht({attribute:!1})],Dt.prototype,"settings",void 0),t([ht({attribute:!1})],Dt.prototype,"notifyServices",void 0),t([pt()],Dt.prototype,"_local",void 0),yt("wd-settings-dialog",Dt);class Pt extends nt{constructor(){super(...arguments),this.narrow=!1,this.items=[],this.categories=[],this.settings={warning_days:30,urgent_days:7,critical_days:1,notifications:{enabled:!1,targets:[],statuses:["urgent","critical","expired"]}},this.activeCategory="all",this.statusFilter="active",this.search="",this.dialog=null,this.loaded=!1,this.openAddItem=()=>{const t=this.categories[0]?.id??"other";this.dialog={kind:"item",draft:xt(t)}},this.openCategories=()=>{this.dialog={kind:"categories"}},this.openAddCategory=()=>{this.dialog={kind:"category",draft:{name:"",icon:"mdi:tag",color:"#78909C"}}},this.openSettings=()=>{this.dialog={kind:"settings"}},this.closeDialog=()=>{this.dialog=null}}connectedCallback(){super.connectedCallback(),this.api=new gt(this.hass),async function(t=5e3){const e=window;if("function"==typeof e.loadCardHelpers)try{await e.loadCardHelpers()}catch{}const i=ft.map(t=>customElements.whenDefined(t));await Promise.race([Promise.all(i),new Promise(e=>setTimeout(e,t))])}().catch(()=>{}),this.refresh()}get strings(){return t=this.hass?.language,t&&t.toLowerCase().startsWith("ro")?$t:vt;var t}async refresh(){const t=await this.api.getAll();this.items=t.items,this.categories=t.categories,this.settings=t.settings,this.loaded=!0}getCategory(t){return this.categories.find(e=>e.id===t)}filteredItems(){const t=this.search.trim().toLowerCase();return this.items.filter(t=>"done"===this.statusFilter?"completed"===t.status:"completed"!==t.status).filter(t=>"all"===this.activeCategory||t.category_id===this.activeCategory).filter(e=>!t||e.name.toLowerCase().includes(t)||(e.notes||"").toLowerCase().includes(t)).sort((t,e)=>{if("done"===this.statusFilter){const i=t.completed_at?Date.parse(t.completed_at):0;return(e.completed_at?Date.parse(e.completed_at):0)-i}return t.days_until_due-e.days_until_due})}openEditItem(t){this.dialog={kind:"item",draft:wt(t)}}async deleteItem(t){confirm(this.strings.confirmDelete)&&(await this.api.deleteItem(t.id),await this.refresh())}async markDone(t){await this.api.markDone(t.id),await this.refresh()}async uncomplete(t){await this.api.uncompleteItem(t.id),await this.refresh()}async saveItem(t){const e={name:t.name.trim(),due_date:t.due_date,category_id:t.category_id,icon:t.icon||"mdi:calendar",notes:t.notes,recurrence:t.recurrence,recurrence_days:"custom"===t.recurrence?t.recurrence_days??void 0:void 0};t.id?await this.api.updateItem(t.id,e):await this.api.addItem(e),this.dialog=null,await this.refresh()}openEditCategory(t){this.dialog={kind:"category",draft:Ct(t)}}async deleteCategory(t){confirm(this.strings.confirmDeleteCategory)&&(await this.api.deleteCategory(t.id),await this.refresh(),this.activeCategory===t.id&&(this.activeCategory="all"))}async saveCategory(t){t.id?await this.api.updateCategory(t.id,{name:t.name.trim(),icon:t.icon,color:t.color}):await this.api.addCategory({name:t.name.trim(),icon:t.icon,color:t.color}),await this.refresh(),this.dialog={kind:"categories"}}async saveSettings(t){await this.api.updateSettings(t),this.dialog=null,await this.refresh()}formatDays(t){const e=this.strings;if("completed"===t.status&&t.completed_at)return`${e.completedOn} ${this._formatTimestamp(t.completed_at)}`;const i=t.days_until_due;return i<0?`${Math.abs(i)} ${e.daysOverdue}`:0===i?e.dueToday:1===i?e.dueTomorrow:`${i} ${e.daysLeft}`}_formatTimestamp(t){return t.slice(0,10)}render(){const t=this.strings,e=this.filteredItems();return q`
      <div class="app">
        ...
        <div class="grid">
          ${this.loaded?0===e.length?q`<div class="empty">${t.empty}</div>`:e.map(t=>this._renderCard(t)):F}
        </div>
    ...
    `}_renderDialog(){if(!this.dialog)return F;const t=this.strings;if("item"===this.dialog.kind)return q`
        <wd-item-dialog
          .strings=${t}
  ...
  `,t([ht({attribute:!1})],Pt.prototype,"hass",void 0),t([ht({attribute:!1})],Pt.prototype,"narrow",void 0),t([ht({attribute:!1})],Pt.prototype,"route",void 0),t([ht({attribute:!1})],Pt.prototype,"panel",void 0),t([pt()],Pt.prototype,"items",void 0),t([pt()],Pt.prototype,"categories",void 0),t([pt()],Pt.prototype,"settings",void 0),t([pt()],Pt.prototype,"activeCategory",void 0),t([pt()],Pt.prototype,"statusFilter",void 0),t([pt()],Pt.prototype,"search",void 0),t([pt()],Pt.prototype,"dialog",void 0),t([pt()],Pt.prototype,"loaded",void 0),yt("whats-due-panel",Pt);export{Pt as WhatsDuePanel};
