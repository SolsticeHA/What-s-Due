...
`;class bt extends nt{constructor(){super(...arguments),this.label="",this.value="",this._onChange=t=>{this._emit(t.detail.value)}}render(){return t="ha-icon-picker",void 0!==customElements.get(t)?F`
        <ha-icon-picker
          .label=${this.label}
          .value=${this.value}
  ...
  `,t([ht()],bt.prototype,"label",void 0),t([ht()],bt.prototype,"value",void 0),yt("wd-icon-picker",bt);class At extends nt{constructor(){super(...arguments),this.categories=[],this._cancel=()=>{this.dispatchEvent(new CustomEvent("cancel"))},this._save=()=>{this._local.name.trim()&&this._local.due_date&&this.dispatchEvent(new CustomEvent("save",{detail:this._local}))}}willUpdate(t){t.has("draft")&&this.draft&&(this._local={...this.draft})}_patch(t,e){this._local={...this._local,[t]:e},this.requestUpdate()}render(){if(!this._local)return B;const t=this.strings,e=this._local;return F`
      ...
      >
        <div class="wd-form">
          ...
          <div class="wd-field">
            ...
            <div class="wd-chip-group">
              ${[["none",t.recurrenceNone],["monthly",t.recurrenceMonthly],["yearly",t.recurrenceYearly],["custom",t.recurrenceCustom]].map(([t,i])=>F`
                  <button
                    type="button"
    ...
    `}}function Ct(t){return{id:t.id,name:t.name,icon:t.icon,color:t.color}}At.styles=_t,t([ht({attribute:!1})],At.prototype,"strings",void 0),t([ht({attribute:!1})],At.prototype,"categories",void 0),t([ht({attribute:!1})],At.prototype,"draft",void 0),t([pt()],At.prototype,"_local",void 0),yt("wd-item-dialog",At);class kt extends nt{constructor(){super(...arguments),this._cancel=()=>this.dispatchEvent(new CustomEvent("cancel")),this._save=()=>{this._local.name.trim()&&this.dispatchEvent(new CustomEvent("save",{detail:this._local}))}}willUpdate(t){t.has("draft")&&this.draft&&(this._local={...this.draft})}_patch(t,e){this._local={...this._local,[t]:e},this.requestUpdate()}render(){if(!this._local)return B;const t=this.strings,e=this._local;return F`
      <ha-dialog
        open
    ...
    `],t([ht({attribute:!1})],kt.prototype,"strings",void 0),t([ht({attribute:!1})],kt.prototype,"draft",void 0),t([pt()],kt.prototype,"_local",void 0),yt("wd-category-dialog",kt);class Et extends nt{constructor(){super(...arguments),this.categories=[],this._close=()=>this.dispatchEvent(new CustomEvent("close")),this._add=()=>this.dispatchEvent(new CustomEvent("add"))}_edit(t){this.dispatchEvent(new CustomEvent("edit",{detail:t}))}_delete(t){this.dispatchEvent(new CustomEvent("delete",{detail:t}))}render(){const t=this.strings;return F`
      <ha-dialog
        open
      ...
      >
        <div class="list">
          ${0===this.categories.length?F`<div class="empty">—</div>`:this.categories.map(e=>F`
                  <div class="row">
    ...
    `],t([ht({attribute:!1})],Et.prototype,"strings",void 0),t([ht({attribute:!1})],Et.prototype,"categories",void 0),yt("wd-categories-dialog",Et);const St=["warning","urgent","critical","expired"];class Dt extends nt{constructor(){super(...arguments),this.notifyServices=[],this._cancel=()=>this.dispatchEvent(new CustomEvent("cancel")),this._save=()=>{this.dispatchEvent(new CustomEvent("save",{detail:this._local}))}}willUpdate(t){t.has("settings")&&this.settings&&(this._local={...this.settings,notifications:{...this.settings.notifications,targets:[...this.settings.notifications?.targets??[]],statuses:[...this.settings.notifications?.statuses??[]]}})}_patch(t,e){this._local={...this._local,[t]:e},this.requestUpdate()}_patchNotif(t,e){this._local={...this._local,notifications:{...this._local.notifications,[t]:e}},this.requestUpdate()}_toggleStatus(t,e){const i=new Set(this._local.notifications.statuses);e?i.add(t):i.delete(t),this._patchNotif("statuses",Array.from(i))}_toggleTarget(t){const e=new Set(this._local.notifications.targets);e.has(t)?e.delete(t):e.add(t),this._patchNotif("targets",Array.from(e))}_num(t){const e=parseInt(t.target.value,10);return Number.isFinite(e)&&e>=0?e:0}_renderNotifBody(t){const e=this.strings,i=[...this.notifyServices].sort();for(const e of t.targets)i.includes(e)||i.push(e);return F`
      <div class="notif-body">
        <div class="hint">${e.notificationsTargets}</div>
        ${0===i.length?F`<div class="empty-note">${e.notificationsNoServices}</div>`:F`
              <div class="wd-chip-group">
                ${i.map(e=>F`
                    <button
                      type="button"
    ...
    `}_statusLabel(t){const e=this.strings;switch(t){case"warning":return e.statusWarning;case"urgent":return e.statusUrgent;case"critical":return e.statusCritical;case"expired":return e.statusExpired}}render(){if(!this._local)return B;const t=this.strings,e=this._local,i=e.notifications;return F`
      <ha-dialog
        open
        heading=${t.settings}
        @closed=${t=>{t.detail?.action&&this._cancel()}}
      >
        <div class="form">
          ...
          ${i.enabled?this._renderNotifBody(i):B}
        </div>
      ...
      <div class="app">
        ...
        <div class="filter-row">
          <div class="segmented" role="tablist">
            <button
              role="tab"
              aria-selected=${"active"===this.statusFilter}
            ...
            <button
              role="tab"
              aria-selected=${"done"===this.statusFilter}
        ...
        <div class="grid">
          ${this.loaded?0===e.length?F`<div class="empty">${t.empty}</div>`:e.map(t=>this._renderCard(t)):B}
        </div>
    ...
    `}_renderCard(t){const e=this.getCategory(t.category_id),i=this.strings,s="completed"===t.status;return F`
    ...
    `}_renderDialog(){if(!this.dialog)return B;const t=this.strings;if("item"===this.dialog.kind)return F`
        <wd-item-dialog
          .strings=${t}
        ...
        ></wd-item-dialog>
      `;if("categories"===this.dialog.kind)return F`
        ...
        ></wd-categories-dialog>
      `;if("category"===this.dialog.kind)return F`
        <wd-category-dialog
          .strings=${t}
          .draft=${this.dialog.draft}
        ...
        ></wd-category-dialog>
      `;if("settings"===this.dialog.kind){const e=Object.keys(this.hass?.services?.notify??{});return F`
        <wd-settings-dialog
          .strings=${t}
