...
`;let bt=class extends nt{constructor(){super(...arguments),this.label="",this.value="",this._onChange=t=>{this._emit(t.detail.value)}}render(){return t="ha-icon-picker",void 0!==customElements.get(t)?q`
  ...
  `,t([pt()],bt.prototype,"label",void 0),t([pt()],bt.prototype,"value",void 0),bt=t([lt("wd-icon-picker")],bt);let At=class extends nt{constructor(){super(...arguments),this.categories=[],this._cancel=()=>{this.dispatchEvent(new CustomEvent("cancel"))},this._save=()=>{this._local.name.trim()&&this._local.due_date&&this.dispatchEvent(new CustomEvent("save",{detail:this._local}))}}willUpdate(t){t.has("draft")&&this.draft&&(this._local={...this.draft})}_patch(t,e){this._local={...this._local,[t]:e},this.requestUpdate()}render(){if(!this._local)return V;const t=this.strings,e=this._local;return q`
      ...
      >
        <div class="wd-form">
          ...
          <label class="wd-field">
            ...
            <select
              .value=${e.category_id}
              @change=${t=>this._patch("category_id",t.target.value)}
            >
              ${this.categories.map(t=>q`
                  <option value=${t.id} ?selected=${t.id===e.category_id}>
                    ${t.name}
                  </option>
                `)}
            </select>
          ...
          <label class="wd-field">
            ...
            <select
              .value=${e.recurrence}
              @change=${t=>this._patch("recurrence",t.target.value)}
            >
              <option value="none" ?selected=${"none"===e.recurrence}>
                ${t.recurrenceNone}
              </option>
              <option value="monthly" ?selected=${"monthly"===e.recurrence}>
                ${t.recurrenceMonthly}
              </option>
              <option value="yearly" ?selected=${"yearly"===e.recurrence}>
                ${t.recurrenceYearly}
              </option>
              <option value="custom" ?selected=${"custom"===e.recurrence}>
                ${t.recurrenceCustom}
              </option>
            </select>
          </label>
    ...
    `],t([pt({attribute:!1})],Et.prototype,"strings",void 0),t([pt({attribute:!1})],Et.prototype,"draft",void 0),t([ut()],Et.prototype,"_local",void 0),Et=t([lt("wd-category-dialog")],Et);let St=class extends nt{constructor(){super(...arguments),this.categories=[],this._close=()=>this.dispatchEvent(new CustomEvent("close")),this._add=()=>this.dispatchEvent(new CustomEvent("add"))}_edit(t){this.dispatchEvent(new CustomEvent("edit",{detail:t}))}_delete(t){this.dispatchEvent(new CustomEvent("delete",{detail:t}))}render(){const t=this.strings;return q`
    ...
    `],t([pt({attribute:!1})],St.prototype,"strings",void 0),t([pt({attribute:!1})],St.prototype,"categories",void 0),St=t([lt("wd-categories-dialog")],St);let kt=class extends nt{constructor(){super(...arguments),this._cancel=()=>this.dispatchEvent(new CustomEvent("cancel")),this._save=()=>{this.dispatchEvent(new CustomEvent("save",{detail:this._local}))}}willUpdate(t){t.has("settings")&&this.settings&&(this._local={...this.settings})}_patch(t,e){this._local={...this._local,[t]:e},this.requestUpdate()}_num(t){const e=parseInt(t.target.value,10);return Number.isFinite(e)&&e>=0?e:0}render(){if(!this._local)return V;const t=this.strings,e=this._local;return q`
